    ...
    <?php if (empty($id_member)) : ?>
        <section class="container blue-text">
            ...
            <form action="" method="post">
                ...
                <label class="black-text" for="password">Konfirmasi Password : </label>
    ...
    <?php if (!empty($id_member)) : ?>
        ...
        <section class="container blue-text">
            ...
            <form action="" method="post">
                ...
                <label class="black-text" for="password">Password : </label>
                <input type="password" name="password" id="password" required value="<?= $member["password"] ?>">
                <label class="black-text" for="password">Konfirmasi Password : </label>
                <input type="password" name="password2" id="password2" required value="<?= $member["password"] ?>">
