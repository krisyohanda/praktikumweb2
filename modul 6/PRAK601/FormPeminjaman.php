    ...
    <?php if (empty($id_peminjaman)) : ?>
        <section class="container red-text">
            ...
            <form action="" method="post">
                ...
                <div class="center">
                    <button class="waves-effect waves-light red btn-small" type="submit" name="submit"><i class="material-icons left">send</i>Submit</button>
    ...
    <?php if (!empty($id_peminjaman)) : ?>
        ...
        <section class="container red-text">
            ...
            <form action="" method="post">
                ...
                <div class="center">
                    <button class="waves-effect waves-light red btn-small" type="submit" name="ubah"><i class="material-icons left">send</i>Ubah</button>
                    <a href="Peminjaman.php" class="waves-effect waves-light grey btn-small"><i class="material-icons left">close</i>Kembali</a>
                </div>
            </form>
        </section>
